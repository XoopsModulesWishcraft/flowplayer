 ...
 * @access 		public
 */
class FlowplayerFormSelectSupport extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function FlowplayerFormSelectSupport($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_MI_FLOWPLAYER_FLASH', '_MI_FLOWPLAYER_HTML5', '_MI_FLOWPLAYER_HTTP', '_MI_FLOWPLAYER_IOS', '_MI_FLOWPLAYER_RTMP', '_MI_FLOWPLAYER_RTSP', '_MI_FLOWPLAYER_SILVERLIGHT', '_MI_FLOWPLAYER_OTHER') as $enum)
