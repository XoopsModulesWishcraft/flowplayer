 ...
 * @access 		public
 */
class FlowplayerFormSelectMimetype extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function FlowplayerFormSelectMimetype($caption, $name, $value = null, $size = 1, $multiple = false, $none = true)
    {
        ...
        $player_handler = xoops_getmodulehandler('mimetypes', 'flowplayer');
		foreach($player_handler->getObjects(NULL, true) as $mid => $obj)
